...
const LOCAL_STORAGE_KEY = 'school-cloud-fallback-data';
...
async function handleAuthButtonClick() {
  ...
  if (elements.authButton?.dataset.state === 'signed') {
    try {
      ...
      console.error('[School Cloud] Odhlášení selhalo', error);
  ...
  try {
    ...
    console.error('[School Cloud] Přihlášení selhalo', error);
